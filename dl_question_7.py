...
Original file is located at
    https://colab.research.google.com/drive/14jeUYVdTQ5dsoOBaeH95T-Fyb2xgKR7G
"""
...
#default config
#neuralNetwork(epochs=15,batch_size= 64,optimizer ='momentum',learning_rate = 0.1,beta =0.01,beta1 = 0.9,beta2 =0.99,epsilon =1e-8,weight_init='xavier',num_layers=3,hidden_size=64,activation='ReLU',momentum=0.9)
      
#not working 
#neuralNetwork(epochs=15,batch_size= 64,optimizer ='rmsprop',learning_rate = 0.01,beta =0.01,beta1 = 0.9,beta2 =0.99,epsilon =1e-8,weight_init='xavier',num_layers=4,hidden_size=64,activation='sigmoid',momentum=0.9)

#epsilon 1e-6 sahi hai
#neuralNetwork(epochs=15,batch_size= 64,optimizer ='rmsprop',learning_rate = 0.001,beta =0.9,beta1 = 0.9,beta2 =0.99,epsilon =1e-3,weight_init='random',num_layers=3,hidden_size=64,activation='tanh',momentum=0.9,loss_function='cross_entropy',weight_decay=0.0005)
    

# wandb: Agent Starting Run: c3jpz9jr with config:
...
#         'learning_rate' : { 'values' : [0.1, 0.08,0.01, 0.002]},
